...
public class MarketingReduction {
    ...
    public void Login() {
        ...
        MarketingReduction.browser.explicitlyWait(By.xpath(LoginElement.login_button),20);
    ...
    public void ReductionCoupon() throws InterruptedException {
        MarketingReduction.browser.explicitlyWait(By.xpath(ShopElement.my_shop_button), 20);
    ...
    public void AddReductionCoupon() throws InterruptedException {
        MarketingReduction.browser.explicitlyWait(By.xpath(MarketingReductionElement.add_reduction_coupon_button), 20);
    ...
    public void OfflineReductionCoupon() throws InterruptedException {
        MarketingReduction.browser.explicitlyWait(By.xpath(MarketingReductionElement.offline_button), 20);
        ...
        MarketingReduction.browser.explicitlyWait(By.xpath(MarketingReductionElement.offline_text), 20);
    ...
    public void DeleteReductionCoupon() throws InterruptedException {
        MarketingReduction.browser.explicitlyWait(By.xpath(MarketingReductionElement.delete_button), 20);
