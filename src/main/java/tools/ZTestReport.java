...
public class ZTestReport implements IReporter {
	...
	private String templatePath = System.getProperty("user.dir") + File.separator + "/src/main/java/tools/template";
	...
	private void outputResult(List<ITestResult> list) {
		try {
			...
			for (ITestResult result : list) {
				...
				double spendTime = (result.getEndMillis() - result.getStartMillis())/1000.0;
				DecimalFormat decimalFormat = new DecimalFormat("#.000");
				totalTime = Double.parseDouble(decimalFormat.format(totalTime + spendTime));
